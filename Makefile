...
url_test:
	$(CXX) -Wall -Wnon-virtual-dtor -DBOOST_TEST_MAIN -DBOOST_TEST_DYN_LINK ./src/url.cpp ./src/path.cpp Url_test.cpp -lboost_unit_test_framework -I ./include -o url_test
